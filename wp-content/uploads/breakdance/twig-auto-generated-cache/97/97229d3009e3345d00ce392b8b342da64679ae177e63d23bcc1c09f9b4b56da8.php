...
/* 57dbadac3f2c3af96e86dd11563e44e75e63f36a */
class __TwigTemplate_3c5feb861d6da24d78143d4ba613e107d41bf472279f1cc96dec5f567fbb03e7 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo "
          ";
        // line 2
        $macros["macros"] = $this->macros["macros"] = $this->loadTemplate("macros.twig", "57dbadac3f2c3af96e86dd11563e44e75e63f36a", 2)->unwrap();
        // line 3
        echo "
          ";
        // line 4
...
>
          ...
          <div class=\"breakdance-form-field breakdance-form-field--text\" >
            ...
            Company<span class=\"breakdance-form-field__required\">*</span></span>
        </label>
...
<footer class=\"breakdance-form-field breakdance-form-footer\">
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["step"]) {
            ...
            echo twig_get_attribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, false, 140);
            echo "\">
            ";
            // line 141
            echo twig_call_macro($macros["macros"], "macro_atomV1ButtonHtmlManual", [(((twig_get_attribute($this->env, $this->source, $context["step"], "previous_button_text", [], "any", true, true, false, 141) &&  !(null === twig_get_attribute($this->env, $this->source, $context["step"], "previous_button_text", [], "any", false, false, false, 141)))) ? (twig_get_attribute($this->env, $this->source, $context["step"], "previous_button_text", [], "any", false, false, false, 141)) : ("Previous Step")), false, "breakdance-form-button breakdance-form-button__previous-step hidden", ($context["previousStepButtonDesign"] ?? null), "secondary", false, false, "step.next_button_text"], 141, $context, $this->getSourceContext());
            echo "
            ";
            // line 142
            echo twig_call_macro($macros["macros"], "macro_atomV1ButtonHtmlManual", [(((twig_get_attribute($this->env, $this->source, $context["step"], "next_button_text", [], "any", true, true, false, 142) &&  !(null === twig_get_attribute($this->env, $this->source, $context["step"], "next_button_text", [], "any", false, false, false, 142)))) ? (twig_get_attribute($this->env, $this->source, $context["step"], "next_button_text", [], "any", false, false, false, 142)) : ("Next Step")), false, "breakdance-form-button breakdance-form-button__next-step hidden", ($context["nextStepButtonDesign"] ?? null), "primary", false, false, "step.next_button_text"], 142, $context, $this->getSourceContext());
            echo "
        </div>
    ";
            ++$context['loop']['index0'];
        ...
        // line 145
        echo "    ";
        echo twig_call_macro($macros["macros"], "macro_atomV1ButtonHtmlManual", [(($context["submitButtonText"]) ?? ("Submit")), false, "breakdance-form-button breakdance-form-button__submit", ($context["submitButtonDesign"] ?? null), "primary", ($context["submitButtonId"] ?? null), true, "content.form.submit_text"], 145, $context, $this->getSourceContext());
        echo "
  ...
  ";
    ...
    {
        return "57dbadac3f2c3af96e86dd11563e44e75e63f36a";
    }
    ...
    {
        return array (  310 => 150,  301 => 145,  284 => 142,  280 => 141,  275 => 140,  258 => 139,  252 => 136,  149 => 35,  144 => 32,  128 => 29,  122 => 27,  120 => 26,  117 => 25,  111 => 23,  105 => 21,  103 => 20,  97 => 18,  80 => 17,  76 => 15,  74 => 14,  70 => 13,  56 => 12,  53 => 11,  51 => 9,  50 => 8,  49 => 6,  47 => 5,  45 => 4,  42 => 3,  40 => 2,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "57dbadac3f2c3af96e86dd11563e44e75e63f36a", "");
    }
}
